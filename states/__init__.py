...
def read_min_wages_file(state_name, type_skilled, input_filelocation):
    ...
    if min_wagesfilename:
        ...
        logging.info(
            "Didin't find min wages file hence setting minimum wages to 0")
        min_wages = 0
    return min_wages
